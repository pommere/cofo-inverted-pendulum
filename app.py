...
def calculate_g_physics(step_freq, hip_cm, ankle_cm):
    ...
    # Matches your lab manual's center of mass
    L_cm = 0.55 * L_total 
    # We use L_cm as our L_eff for a "Simple Pendulum" approximation.
    # This keeps the '0.55' visible to the student so they aren't confused.
    L_eff = L_cm 
